...
function getSBF120PaymentSchedule() {
    ...
    const RAW_PAYMENTS = [
        ...
        { csv_ticker: 'TTEF', Societe: 'TotalEnergies SE', Montant: 0.85, DatePaiement: '03/10/2025', Versement: 'Trimestriel' }, // VERSE
        ...
        { csv_ticker: 'STMPA', Societe: 'STMicroelectronics', Montant: 0.09, DatePaiement: '24/09/2025', Versement: 'Trimestriel' }, // VERSE
        { csv_ticker: 'STMPA', Societe: 'STMicroelectronics', Montant: 0.09, DatePaiement: '17/12/2025', Versement: 'Trimestriel' }, // PROCHAIN
        ...
        { csv_ticker: 'SGEF', Societe: 'Vinci', Montant: 1.05, DatePaiement: '16/10/2025', Versement: 'Acompte' }, // VERSE (le 16/10)
        ...
        { csv_ticker: 'SPIE', Societe: 'Spie', Montant: 0.30, DatePaiement: '18/09/2025', Versement: 'Acompte' }, // VERSE
        { csv_ticker: 'BNPP', Societe: 'BNP Paribas', Montant: 4.79, DatePaiement: '21/05/2025', Versement: 'Annuel' },
        { csv_ticker: 'BNPP', Societe: 'BNP Paribas', Montant: 2.59, DatePaiement: '30/09/2025', Versement: 'Exceptionnel' }, // VERSE
        ...
        { csv_ticker: 'TCFP', Societe: 'Thales', Montant: 0.95, DatePaiement: '04/12/2025', Versement: 'Acompte' }, // PROCHAIN
        ...
        { csv_ticker: 'DAST', Societe: 'Dassault Systèmes', Montant: 0.26, DatePaiement: '28/05/2025', Versement: 'Annuel' }, // CAS DEMANDÉ (DOIT ÊTRE VERSÉ)
...
const initialData = [
    ...
    // Ajout de DSY.PA pour tester la date
...
// --- CORRECTION CRITIQUE: Vérification du statut par date ---
function updateDividendStatusByDate() {
    // Nous sommes le 19/10/2025. Utilisation de getTime() pour une comparaison numérique fiable.
    const today = new Date(2025, 9, 19).getTime(); // Mois 9 = Octobre

    dividendsData.forEach(stock => {
        const dateStr = stock.DateVersement;
        
        if (dateStr && dateStr !== 'N/A') {
            // Parsing de la date JJ/MM/AAAA en objet Date sécurisé
            const parts = dateStr.split('/');
            // new Date(ANNEE, MOIS - 1, JOUR)
            const paymentDate = new Date(parseInt(parts[3], 10), parseInt(parts[4], 10) - 1, parseInt(parts, 10));

            // Comparaison de la date de paiement avec la date du jour
...
function addNewStockSBF120() {
    ...
    payments.forEach(payment => {
        const newStock = {
            ...
            Statut: 'Prévu' // Sera mis à jour par la fonction de statut
        };
...
function renderDividendsTable() {
    ...
    dividendsData.forEach((stock, index) => {
        ...
        row.insertCell().textContent = stock.Statut; // Affichage du statut mis à jour
